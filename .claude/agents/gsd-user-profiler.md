...
<reference>
@/Users/adar/Code/groovy/.claude/get-shit-done/references/user-profiling.md
...
Read the user-profiling reference document at `/Users/adar/Code/groovy/.claude/get-shit-done/references/user-profiling.md` to load:
