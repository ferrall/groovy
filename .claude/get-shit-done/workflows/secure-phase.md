...
```
Agent(
  prompt="Read /Users/adar/Code/groovy/.claude/agents/gsd-security-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `/Users/adar/Code/groovy/.claude/get-shit-done/templates/SECURITY.md`
