...
```bash
INIT=$(node "/Users/adar/Code/groovy/.claude/get-shit-done/bin/gsd-tools.cjs" init ingest-docs)
...
```bash
node "/Users/adar/Code/groovy/.claude/get-shit-done/bin/gsd-tools.cjs" commit \
