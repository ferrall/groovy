...
```bash
INIT=$(node "/Users/adar/Code/groovy/.claude/get-shit-done/bin/gsd-tools.cjs" init phase-op "${PHASE}")
...
Use the SPEC.md template from @/Users/adar/Code/groovy/.claude/get-shit-done/templates/spec.md.
