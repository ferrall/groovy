...
export function Sequencer() {
  ...
  return (
    <div className="bg-slate-800/50 rounded-xl p-6 border border-slate-700">
      {/* Sheet Music Notation Placeholder */}
      <div className="mb-6 p-6 bg-slate-900/50 rounded-lg border border-slate-600 h-32 flex items-center justify-center">
        <div className="text-slate-500 text-sm">♩ = 128 &nbsp;&nbsp; Sheet Music Display</div>
      </div>
